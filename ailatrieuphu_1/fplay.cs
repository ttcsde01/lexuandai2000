...
namespace ailatrieuphu_1
{
    public partial class fplay : Form
    {
        ...
        int index = 0;
        //Lấy câu hỏi từ file excel lưu vào danh sách
        private void laycauhoi()
        {
           ...
           //mở file
            ...
            xlWorkSheet = (Excel.Worksheet)xlWorkBook.Worksheets.get_Item(1);//truyền tham số sheet
        ...
        //Nếu trả lời hết câu hỏi thì chiến thắng
        ...
        //Load form(chạy chương trình game)
      ...
      //Dừng lại khi cần thiết
       ...
       //thời gian đếm ngược để trả lời
        int thoigian = 40;
